...
class ReceivePushAndAbortActivity : AppCompatActivity(), HasToolbar {
    ...
    private fun dispatchNotification() {
        ...
        val notification = Notification("ReceivePushAndAbortActivity Notification", "This notification was received in ReceivePushAndAbortActivity")
